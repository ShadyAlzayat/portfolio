...
const IonPageInternal = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: className !== undefined ? `ion-page ${className}` : 'ion-page', ref: forwardedRef }, props), children));
};
...
const IonTabBar = props => {
    ...
    return (React.createElement(IonTabBarUnwrapped, Object.assign({}, props, { navigate: props.navigate || ((path) => {
