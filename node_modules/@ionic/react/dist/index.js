...
const createReactComponent = (tagName, hrefComponent = false) => {
...
const IonPageInternal = (_a) => {
    ...
    return (React__default.createElement("div", Object.assign({ className: className !== undefined ? `ion-page ${className}` : 'ion-page', ref: forwardedRef }, props), children));
};
const IonPage = /*@__PURE__*/ createForwardRef(IonPageInternal, 'IonPage');
...
const IonTabBar = props => {
    ...
    return (React__default.createElement(IonTabBarUnwrapped, Object.assign({}, props, { navigate: props.navigate || ((path) => {
...
const IonTabs = /*@__PURE__*/ (() => class extends React__default.Component {
    constructor(props) {
        super(props);
